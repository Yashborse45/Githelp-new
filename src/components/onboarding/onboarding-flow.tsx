...
import { CheckCircle, Circle, ArrowRight, BookOpen, MessageSquare, Settings, Zap } from 'lucide-react';
            ...
            {steps.map((step, index) => (
              <div
                ...
                className={`flex items-center gap-3 p-3 rounded-lg transition-colors ${
                  index === currentStep ? 'bg-primary/5 border border-primary/20' : 'hover:bg-muted/50'
                }`}
              >
                {step.completed ? (
